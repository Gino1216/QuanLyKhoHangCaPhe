...
public class PC {
 ...
 private String maMay;
    ...
    public PC(String maMay, String tenMay, int soLuong, double donGia, String boXuLi, String loaiMay, int trangThai){
        
    }

    public PC(String maMay, String tenMay, int soLuong, double gia, String tenCpu, String ram, String xuatXu, String cardManHinh, String Rom,int trangThai) {
        this.maMay = maMay;
        this.tenMay = tenMay;
    ...
    public PC(String maMay, String tenMay, int soLuong, double gia,String tenCpu, String ram,String Rom) {
        this.maMay = maMay;
        this.tenMay = tenMay;
        this.soLuong = soLuong;
        this.gia = gia;
