        ...
        functionBar.setButtonActionListener("sucess", () -> {
            ...
            if (Session.getRole() == 1) {
                ...
                if ("Chưa duyệt".equals(status)) {
                    table.setValueAt("Quản lý duyệt", selectedRow, 5);
                    selectedPhieuNhap.setTrangThai("Quản lý duyệt");

                    DaoPhieuNhap daoPhieuNhap = new DaoPhieuNhap();
                    boolean isSuccess = daoPhieuNhap.QuanLyDuyetPhieuNhap(selectedPhieuNhap);
