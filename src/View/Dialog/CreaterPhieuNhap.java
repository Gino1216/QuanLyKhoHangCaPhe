...
public class CreaterPhieuNhap extends JFrame {
    ...
    private JPanel createCenterPanel() {
        ...
        txtReceiptId = new JTextField("PN-" + System.currentTimeMillis());
        ...
        cbbCoffeeName = new JComboBox<>(new String[]{"Chọn cafe", "Cafe Đắk Lắk", "Cafe Buôn Ma Thuột",
            "Cafe Lâm Đồng", "Cafe Gia Lai", "Cafe Khe Sanh"});
        ...
        cbbSupplier = new JComboBox<>(new String[]{"Chọn nhà cung cấp", "Công Ty Cafe Trung Nguyên",
    ...
    private JPanel createButtonPanel() {
        ...
        btnAdd.addActionListener(e -> {
            ...
            if (coffeeName == null || coffeeName.equals("Chọn cafe")) {
                JOptionPane.showMessageDialog(this, "Vui lòng chọn một loại cafe!",
                        "Lỗi", JOptionPane.ERROR_MESSAGE);
                return;
            }
            if (supplier == null || supplier.equals("Chọn nhà cung cấp")) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(this, "Giá nhập phải là một số dương!",
                        "Lỗi", JOptionPane.ERROR_MESSAGE);
                return;
            }
            try {
                ...
                JOptionPane.showMessageDialog(this, "Số lượng phải là một số dương!",
                        "Lỗi", JOptionPane.ERROR_MESSAGE);
                return;
            }
            try {
                ...
                JOptionPane.showMessageDialog(this, "Trọng lượng phải là một số dương!",
                        "Lỗi", JOptionPane.ERROR_MESSAGE);
                return;
            }

            int stt = table.getRowCount() + 1;
            String coffeeCode = "CF" + String.format("%03d", stt);
        ...
        btnDelete.addActionListener(e -> {
            ...
            for (int i = 0; i < table.getRowCount(); i++) {
                ...
                table.setValueAt("CF" + String.format("%03d", i + 1), i, 1);
            }
    ...
    private JPanel createBottomPanel() {
        ...
        String[] columns = {"STT", "Mã cafe", "Tên cafe", "Loại cafe", "Trọng lượng (kg/bao)",
        ...
        btnSubmit.addActionListener(e -> {
            if (table.getRowCount() == 0) {
                JOptionPane.showMessageDialog(this, "Vui lòng thêm ít nhất một loại cà phê!",
                        "Lỗi", JOptionPane.ERROR_MESSAGE);
                return;
            }
            ...
            List<CoffeItemDTO> coffeeItems = new ArrayList<>();
            for (int i = 0; i < table.getRowCount(); i++) {
                coffeeItems.add(new CoffeItemDTO(
                        ...
                        Long.parseLong(table.getValueAt(i, 5).toString()),
                        Integer.parseInt(table.getValueAt(i, 6).toString())
                ));
            }

            String receiptId = txtReceiptId.getText();
            String employee = txtEmployee.getText();
            String supplierId = "NCC" + System.currentTimeMillis();
            String supplierAddress = getAddressForSupplier(supplier);
            String supplierPhone = "09" + (System.currentTimeMillis() % 1000000000);
            String supplierEmail = supplier.toLowerCase().replace(" ", "") + "@example.com";
            ...
            parent.addPhieuNhap(receiptId, supplier, supplierId, supplierAddress, supplierPhone, supplierEmail,
                    employee, employeeId, employeePhone, employeeEmail, LocalDateTime.now(),
                    totalAmount, coffeeItems);
    ...
    private String getAddressForSupplier(String supplier) {
        return switch (supplier) {
            case "Công Ty Cafe Trung Nguyên" ->
                "123 Đường Láng, Hà Nội";
            case "Nông Trại Cafe Đắk Lắk" ->
                "456 Nguyễn Trãi, TP.HCM";
            case "Hợp Tác Xã Cafe Lâm Đồng" ->
                "789 Lê Lợi, Đà Nẵng";
            default ->
                "Unknown Address";
        };
    ...
    private void updateTotalLabel() {
        String formattedAmount = String.format("TỔNG TIỀN: %,dđ", totalAmount);
