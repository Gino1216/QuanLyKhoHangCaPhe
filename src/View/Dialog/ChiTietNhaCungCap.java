...
public class ChiTietNhaCungCap extends JDialog {
    ...
    public ChiTietNhaCungCap(String id, String name, String phone, String email, String address, String status) {
        FlatLightLaf.setup();
        ...
        String[] labels = {"Mã NCC", "Tên NCC", "Số điện thoại", "Email", "Địa chỉ", "Tình trạng"};
        String[] values = {id, name, phone, email, address, status};
        ...
        btnExportPDF.addActionListener(e -> {
            String[] labelsPDF = {"Mã NCC:", "Tên NCC:", "Số điện thoại:", "Email:", "Địa chỉ:", "Tình trạng:"};
            String[] valuesPDF = {id, name, phone, email, address, status};
            PDFExporter exporter = new PDFExporter();
            exporter.exportToPDF(this, "CHI TIẾT NHÀ CUNG CẤP", labelsPDF, valuesPDF, "E:/ChiTietNhaCungCap_" + id + ".pdf");
        });
