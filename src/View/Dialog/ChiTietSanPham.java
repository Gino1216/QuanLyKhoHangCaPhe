...
public class ChiTietSanPham extends JDialog {
    ...
    public ChiTietSanPham(String id, String name, String quantity, String expiryDate, String materialCode, String storageArea) {
        FlatLightLaf.setup();
        ...
        String[] values = {id, name, quantity, expiryDate, materialCode, storageArea};
