...
public class LoginMain extends JFrame {
    ...
    private static final Color LIGHT_BACKGROUND = new Color(240, 240, 240); // Màu nền sáng
    ...
    // Panel nền cho giao diện, sử dụng màu nền sáng
    private class BackgroundPanel extends JPanel {

        public BackgroundPanel() {
            setBackground(LIGHT_BACKGROUND); // Đặt màu nền sáng
        }
