...
public class CreaterPhieuXuat extends JFrame {
    ...
    // Chỉ giữ constructor nhận PhieuXuat
    ...
    private String getPriceForCoffee(String coffeeName) {
        return switch (coffeeName) {
            case "Cafe Đắk Lắk" ->
                "150000"; // Giá bán cao hơn giá nhập
    ...
    private JPanel createBottomPanel() {
        ...
        btnSubmit.addActionListener(e -> {
            if (table.getRowCount() == 0) {
                JOptionPane.showMessageDialog(this, "Vui lòng thêm ít nhất một loại cafe để xuất hàng!", "Lỗi", JOptionPane.ERROR_MESSAGE);
                return;
            }

            // Gửi dữ liệu về PhieuXuat
            String receiptId = txtReceiptId.getText();
            String customer = (String) cbbCustomer.getSelectedItem();
            String employee = txtEmployee.getText();
            parent.addPhieuXuat(receiptId, customer, employee, totalAmount);
